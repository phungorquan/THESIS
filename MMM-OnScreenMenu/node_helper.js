    ...
    processAction: function(payload) {
        ...
        switch (payload) {
            ...
            case "stop" :
                ...
                break;
            case "shutdown":
                exec("shutdown -h now", opts, (error, stdout, stderr) => { self.checkForExecError(error, stdout, stderr); });
                break;
            case "reboot":
                exec("reboot", opts, (error, stdout, stderr) => { self.checkForExecError(error, stdout, stderr); });
                break;
            case "minimize":
