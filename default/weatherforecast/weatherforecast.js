...
Module.register("weatherforecast",{
	...
	getDom: function() {
		...
		for (var f in this.forecast) {
			...
			// x.id = "img" + f;
  	// 		x.setAttribute("src", "/modules/default/weatherforecast/loading.gif");
	...
	getHeader: function() {
		// Xiu add, don't need localtion here because i put it on currentweather	
	},
