...
Module.register("currentweather",{
	...
	getHeader: function() {
		// Xiu add TEMP degree into header
		var myDegree = "";
		...
		if (this.config.appendLocationNameToHeader) {
			return "(" + myDegree + ")" + this.data.header + " " + this.fetchedLocationName + ", VietNam";
		}

		return  "(" + myDegree + ")" + this.data.header;
	},
